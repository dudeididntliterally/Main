    ...
    if httprequest_loader and typeof(httprequest_loader) == "function" then
        response = httprequest_loader({
            Url = "https://raw.githubusercontent.com/dudeididntliterally/Backup_Repo/refs/heads/main/Notify_Lib.lua",
            Method = "GET"
        })
    else
    ...
    local Flames_Module = loadstring(game:HttpGet('https://raw.githubusercontent.com/dudeididntliterally/Backup_Repo/refs/heads/main/Flames_Hub_API.lua'))()
    getgenv().Module_For_Flames_Hub = Flames_Module
    if getgenv().AllClipboards then getgenv().AllClipboards("https://github.com/EnterpriseExperience/MicUpSource/releases") end
    wait()
    local Window 
    wait(0.2)
